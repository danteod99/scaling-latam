...
const DisenaTuGranja = () => {
  ...
  const handleStartConfigurator = () => {
    ...
    fbEvent("StartQuiz", { content_name: "Configurador DTG (Diseña Tu Granja)" });
    setTimeout(() => {
  ...
  const handleNext = () => {
    ...
    if (currentStep < steps.length - 1) {
      ...
      fbEvent("CompleteRegistration", { content_name: "Quiz DTG Completado" });
      configuratorRef.current?.scrollIntoView({ behavior: "smooth" });
    }
  };
  ...
  useEffect(() => {
    if (processing) {
      // Fire Lead event
      fbEvent("Lead", { content_name: "Quiz DTG Finalizado" });
      ...
      supabase.from("quiz_submissions").insert({
        ...
        source: summary.source ? `Diseña Tu Granja · ${summary.source}` : "Diseña Tu Granja",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        title="Diseña tu Granja de Bots — Ingreso Automatizado 24/7"
        description="Arma tu granja de bots a medida y genera ingresos en automático en YouTube, TikTok, Spotify y Facebook. Responde el quiz y recibe tu plan personalizado."
        path="/landing/disena-tu-granja"
      />
      <Navbar />
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="animate-fade-in-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 mb-6">
                ...
                <span className="text-xs font-medium tracking-wider uppercase text-primary">
                  Ingreso automatizado en dólares
                </span>
              </div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 uppercase leading-tight glow-text-double animate-glow-dynamic" style={{ fontFamily: "'Bebas Neue', 'Anton', sans-serif" }}>
                Tu <span className="text-primary">Granja de Bots</span> trabajando por ti{" "}
                <span className="text-cyan">las 24 horas</span>
              </h1>

              <p className="text-lg md:text-xl text-muted-foreground mb-4 leading-relaxed max-w-xl">
                Un sistema automatizado que genera ingresos solo en YouTube, TikTok, Spotify y Facebook — sin que tengas que estar frente a la pantalla.
              </p>

              <p className="text-base text-white mb-8 max-w-xl font-medium">
                Diseña tu granja ideal en menos de 2 minutos: elige plataforma, dispositivos y meta de ingresos. Te la entregamos lista para operar.
              </p>
            ...
            <div className="relative animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <div className="relative rounded-2xl overflow-hidden border-2 border-primary/20 shadow-[0_0_60px_rgba(0,122,191,0.15)] max-h-[600px]">
                <img src={granjaReal} alt="Granja de bots real operando 24/7" className="w-full h-full object-cover object-center max-h-[600px]" style={{ objectPosition: "center 40%" }} />
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="glass-card-3d rounded-xl p-4 border border-cyan/30">
                    ...
                    <p className="text-sm text-cyan">Ingresos en automático · 24/7</p>
                  </div>
                </div>
              </div>
