...
const EVENT_DATE = new Date("2026-03-05T19:00:00-05:00"); // Lima time
...
const MasterClass = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        🔥 MASTERCLASS GRATUITA / 90 minutos EN VIVO — Cupos limitados 5 de marzo — 7:00 PM (hora Perú) 🇵🇪
      </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-10 text-sm">
            (contador hasta el jueves 5 de 7pm hora Perú 🇵🇪)
          </p>
